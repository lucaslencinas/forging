    ...
    <footer className="border-t border-white/5 px-6 py-16">
      <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-2 gap-8 text-sm">
            <div>
              ...
              <ul className="space-y-2 text-zinc-400">
                <li><a href="/#supported-games" className="hover:text-white transition-colors">Supported Games</a></li>
                <li><a href="/#how-it-works" className="hover:text-white transition-colors">How It Works</a></li>
                <li><a href="/new" className="hover:text-white transition-colors">Start Analysis</a></li>
              </ul>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 text-center text-sm text-zinc-500">
          <p>Built for the Gemini 3 Hackathon · © 2026 Forging</p>
        </div>
      </div>
    </footer>
  );
